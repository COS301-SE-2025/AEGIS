...
//	_ "aegis-api/services_/evidence/metadata"
//	"aegis-api/services_/evidence/upload"
//	_ "aegis-api/services_/evidence/upload"
//	"aegis-api/structs"
//	"archive/zip"
//	"bytes"
//	"net/http"
...
//	download *evidence_download.Service
//	metadata *metadata.Service
//	upload   *upload.Service
//}
//
//func NewEvidenceHandler(download *evidence_download.Service, metadata *metadata.Service, upload *upload.Service) *EvidenceServices {
...
//	}
//
//	files, err := e.download.DownloadEvidence(userID)
//	if err != nil {
//		c.JSON(http.StatusInternalServerError, structs.ErrorResponse{
