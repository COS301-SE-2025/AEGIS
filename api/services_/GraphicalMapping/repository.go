...
func (r *iocRepository) GetByID(id uint) (*IOC, error) {
	var ioc IOC
...
func (r *iocRepository) ListByTenant(tenantID uint) ([]*IOC, error) {
	var iocs []*IOC
...
func (r *iocRepository) ListByCase(caseID uint) ([]*IOC, error) {
	var iocs []*IOC
...
func (r *iocRepository) FindSimilar(tenantID uint, iocType, value string) ([]*IOC, error) {
	var iocs []*IOC
